...
<!--End Nav Menu-->
	<div id="containerShell2"  style="height:740px;">
<div style="color:white;font-size:25px;font-weight:bold;font-family:verdana;padding-left:15px;">
Contact Us
</div>
<!--
<form action="contactus_email.php" method="post" name="frm">
<table style="margin-left:50px;margin-top:30px;color:white;font-size:15px;" width="750">
<tr valign="top"><td colspan="3"><b>Contact Us Form</b><br><br></td></tr>
<tr><td align="right" width="140">Name:</td><td width="10"></td><td width="600"><input name="name" style="border:1px solid black;width:400px;"></td></tr>
<tr><td align="right">Email Address:</td><td></td><td><input name="email" style="border:1px solid black;width:400px;"></td></tr>
<tr><td align="right">Your Company:</td><td></td><td><input name="company" style="border:1px solid black;width:400px;"></td></tr>
<tr><td align="right">Phone:</td><td></td><td><input name="phone" style="border:1px solid black;width:400px;"></td></tr>
<tr><td align="right">Subject:</td><td></td><td><input name="subject" style="border:1px solid black;width:400px;"></td></tr>
<tr valign="top"><td align="right">Your Areas of Interest:</td><td></td><td>
<table width="600">
<tr style="color:white;"><td width="200"><input name="areas_of_interest1" value="Client Services" type="checkbox"> Client Services</td><td width="400"><input name="areas_of_interest4" value="Employee Services" type="checkbox"> Employee Services</td></tr>
<tr style="color:white;"><td width="200"><input name="areas_of_interest2" value="Travel Privileges" type="checkbox"> Travel Privileges</td><td width="400"><input name="areas_of_interest5" value="Payroll" type="checkbox"> Payroll</td></tr>
<tr style="color:white;"><td width="200"><input name="areas_of_interest3" value="HR Services" type="checkbox"> HR Services</td><td width="400"><input name="areas_of_interest6" value="DGS Benefits" type="checkbox"> DGS Benefits</td></tr>
</table>
</td></tr>
<tr valign="top"><td align="right">Message:</td><td></td><td><textarea name="message" rows="5" style="border:1px solid black;width:400px;"></textarea></td></tr>
<tr valign="top"><td colspan="3" height="5"></td></tr>
<tr valign="top"><td align="right"><input name="routing_options1" value="Employer" type="checkbox"><br></td><td></td><td>
Are you an employer?
</td></tr>
<tr valign="top"><td align="right"><input name="routing_options2" value="Seeking staffing assistance" type="checkbox"><br></td><td></td><td>
Do you represent a company seeking assistance with your staffing needs?
</td></tr>
<tr valign="top"><td align="right"><input name="routing_options3" value="DGS Employee" type="checkbox"><br></td><td></td><td>
Are you a DGS employee?
</td></tr>
<tr valign="top"><td align="right"><input name="routing_options4" value="General Inquiry" type="checkbox"><br></td><td></td><td>
Other / General Inquiry
</td></tr>
<tr valign="top"><td colspan="3" height="10"></td></tr>
<tr><td align="right"></td><td></td><td><input type="submit" value="submit" style="color:black;background-color:white;width:150px;"></td></tr>
</table>
</form>
-->
<div style="margin-left:50px;margin-top:30px;color:white;font-size:15px;width:750px;font-weight:bold;">
&middot; Would you like more information on DGS as a staffing service provider for your company?<br><a href="clientservices.php#EMPLOYERFORM" style="color:red;">Contact</a> us for customized staffing solutions and let us show you the <a href="aboutus.php#DGSDIFFERENCE" style="color:red;">DGS Difference</a>!
</div>

<div style="margin-left:50px;margin-top:30px;color:white;font-size:15px;width:750px;font-weight:bold;">
&middot; Are you looking for a job? Search available positions and apply via our <a href="job_board.php" style="color:red;">Job Board</a>.
</div>

<div style="margin-left:50px;margin-top:30px;color:white;font-size:15px;width:750px;font-weight:bold;">
&middot; Are you an existing <u>DGS Staffing Division</u> employee?  We have an <a href="/MyDGS_Entry/MyDGSHome.htm" style="color:red;" target="_blank">employee website</a> exclusively for you!
</div>
...
<br><br>
Delta Global Staffing<br>
1020 Delta Blvd.<br>
A2 Building, Department 996<br>
Atlanta, GA 30354<br>
<br>
<b>Phone:</b> 404-715-4300<br>
<b>Fax:</b> 404-715-4002<br>
<br>
</td>
</tr>
</table>
